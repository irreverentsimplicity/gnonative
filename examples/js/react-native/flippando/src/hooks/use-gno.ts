import { SetRemoteRequest, SetRemoteResponse } from '../../api/gen/es/gnonativetypes_pb';
import { GetRemoteRequest } from '../../api/gen/es/gnonativetypes_pb';
import { SetChainIDRequest, SetChainIDResponse } from '../../api/gen/es/gnonativetypes_pb';
import { GetChainIDRequest } from '../../api/gen/es/gnonativetypes_pb';
import { SetPasswordRequest, SetPasswordResponse } from '../../api/gen/es/gnonativetypes_pb';
import { SelectAccountRequest } from '../../api/gen/es/gnonativetypes_pb';
import { SelectAccountResponse } from '../../api/gen/es/gnonativetypes_pb';
import { CreateAccountRequest } from '../../api/gen/es/gnonativetypes_pb';
import { GenerateRecoveryPhraseRequest } from '../../api/gen/es/gnonativetypes_pb';
import { ListKeyInfoRequest } from '../../api/gen/es/gnonativetypes_pb';
import { HasKeyByNameRequest } from '../../api/gen/es/gnonativetypes_pb';
import { HasKeyByAddressRequest } from '../../api/gen/es/gnonativetypes_pb';
import { HasKeyByNameOrAddressRequest } from '../../api/gen/es/gnonativetypes_pb';
import { GetKeyInfoByNameRequest } from '../../api/gen/es/gnonativetypes_pb';
import { GetKeyInfoByAddressRequest } from '../../api/gen/es/gnonativetypes_pb';
import { GetKeyInfoByNameOrAddressRequest } from '../../api/gen/es/gnonativetypes_pb';
import { GetActiveAccountRequest } from '../../api/gen/es/gnonativetypes_pb';
import { GetActiveAccountResponse } from '../../api/gen/es/gnonativetypes_pb';
import { QueryAccountRequest } from '../../api/gen/es/gnonativetypes_pb';
import { QueryAccountResponse } from '../../api/gen/es/gnonativetypes_pb';
import { DeleteAccountRequest, DeleteAccountResponse } from '../../api/gen/es/gnonativetypes_pb';
import { QueryRequest } from '../../api/gen/es/gnonativetypes_pb';
import { QueryResponse } from '../../api/gen/es/gnonativetypes_pb';
import { RenderRequest } from '../../api/gen/es/gnonativetypes_pb';
import { QEvalRequest } from '../../api/gen/es/gnonativetypes_pb';
import { MsgCall } from '../../api/gen/es/gnonativetypes_pb';
import { CallRequest } from '../../api/gen/es/gnonativetypes_pb';
import { CallResponse } from '../../api/gen/es/gnonativetypes_pb';
import { MsgSend } from '../../api/gen/es/gnonativetypes_pb';
import { SendRequest } from '../../api/gen/es/gnonativetypes_pb';
import { SendResponse } from '../../api/gen/es/gnonativetypes_pb';
import { AddressToBech32Request } from '../../api/gen/es/gnonativetypes_pb';
import { AddressFromBech32Request } from '../../api/gen/es/gnonativetypes_pb';
...
import { GnoNativeService } from '../../api/gen/es/rpc_connect';
